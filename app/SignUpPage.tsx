...
const SignUpForm = ({ onSignUp }) => {
  ...
  return (
    <View className="w-[331px]">
      ...
      <TermsCheckbox checkBoxText={"I agree with the terms and conditions"}/>
      <TouchableOpacity
      ...
      <View className="flex flex-row mt-10">
        ...
        <Text className="flex-1 justify-self-center text-xs font-light text-center">Or Sign Up With</Text>
        <View
      ...
      <View className="items-center ">
        ...
        <View className="flex flex-row">
          ...
          <Text className="text-[#043A8E] text-xs ml-1 font-bold">Login</Text>
        </View>
